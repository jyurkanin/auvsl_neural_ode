...
def print_c_network(md, in_mean, in_std, vx_mean, vx_std, output_scaler):
  ...
  output += "vx_mean = " + str(vx_mean[0]) + ";"
  output += "vx_std = " + str(vx_std[0]) + ";"
...
md = model.state_dict()
print_c_network(md, model.in_mean, model.in_std, model.vx_mean, model.vx_std, output_scaler)
