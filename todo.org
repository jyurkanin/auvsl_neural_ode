...
** TODO Plots for neural/Bekker tire-soil model vx-fx, vy-fy, zr-fz
...
** TODO 2D colormap plot to show unsafe vs safe 3D trajectories

Code you need to write:

** TODO 3D terrain simulation. Could be done with a branch.
Better yet, would be to use OOP and add a class that can provide the ability
to try different terrain maps.
