...
** DONE Fancier tire network model
...
** DONE Will a fancier network with 16 nodes reach a lower
...
The fancier network with the lower pretraining does worse on
CV3. I can't fucking believe it. This is bullshit. It's not
fair. I am upset.

Lower training loss however? So maybe it's just a lack of data
that's killing me here.

What if I just reduced the number of params to like 2 hidden units
Fuck it

** DONE 2 Fucking hidden units
Pretraining loss was trash, CV3 performance was 13%
which is actually better than with 8 nodes. Hmmm?

** DONE Try without zr
Still not convinced it isnt fucking the training.
Nevermind this didnt do shit. Performance was actually worse,
strange.

** TODO WE NEED MORE PARAMS
Parameterize the fucking physical parameters. Every single one? yes.
Don't pull any punches. You have a ton of parameters, you're going to
use every parameter.

** DONE Go back to 8 nodes.
Still not great.
