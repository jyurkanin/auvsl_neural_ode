...
* <2023-05-19 Fri 18:27>
Alright shit. Lets implement this with the classical bekker model
just to test if something else is fucked up. If this gives bad
performance I will actually be happy, because then I at least have another way forward
that isn't just training some variation of yet another fucking model.

* POTENTIAL FUCKING TYPOS THAT ARE FUCKING MY SHIT, FUCK
I think this could be IT:
//gt_state.vx in Trainer.cpp (iykyk)
