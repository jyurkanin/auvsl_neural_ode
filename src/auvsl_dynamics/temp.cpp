...
Eigen::Matrix<Scalar,TireNetwork::num_out_features,1> temp_out_mean;
...
in_std_inv << 0.02886335369235802, 0.5775764506499935, 0.9071540850386793, 23.05669281974966, 865.55833928634, 0.2891942480208505, 0.05777255338265357, 0.1008459080632296;
in_std_inv = in_std_inv.cwiseInverse();

/*
 weight0 = temp_weight0;
 weight2 = temp_weight2;
 weight4 = temp_weight4;
 bias0 = temp_bias0;
 bias2 = temp_bias2;
 bias4 = temp_bias4;
 out_mean = temp_out_mean;
 out_std = temp_out_std;
 in_mean = temp_in_mean;
 in_std_inv = temp_in_std_inv;
*/
return 0;
}
